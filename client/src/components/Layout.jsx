              ...
              <div className="flex h-16 justify-between">
                <div className="flex">
                  <div className="flex flex-shrink-0 items-center">
                    <Link to="/">
                      <h1 className="text-xl font-bold text-primary">MERN Blog</h1>
                    </Link>
                  </div>
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          'inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300'
                        )}
                      >
                        {item.name}
                      </Link>
